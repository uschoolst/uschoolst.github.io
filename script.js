...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyjtPuGK87ozDRf_sMzudIPVLgWZemYjEez5IpqzeOwGrruQavdc8BjHKppI9DYzm8/exec';
...
function render(){
  ...
  if(!inspectorData){
    ...
    document.getElementById('roster-strip').innerHTML = '';
...
function renderPendingPlaces() {
  ...
  if(!tasksData || !checklistData || !inspectorData){
    container.innerHTML = '<div class="empty-hint">資料載入中，或本週清潔工名單尚未公布，請稍候再試…</div>';
    return;
  }
